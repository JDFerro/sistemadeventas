                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" id="password" value="{{ old('password') }}" name="password" placeholder="Ingrese la contraseña" required>
                                @error('password')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" id="password_confirmation" value="{{ old('password_confirmation') }}" name="password_confirmation" placeholder="Confirme la contraseña" required>
                            </div>
                        </div>
                    </div>
                    <hr>
